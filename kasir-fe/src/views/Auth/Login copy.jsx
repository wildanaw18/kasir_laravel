                ...
                <div className="col-md-7 bg-skyblue" style={{ height: '100vh' }}>
                    <div className="row">
                        <div className="col-md-12 d-flex flex-column justify-content-center align-items-center" style={{ height: '100vh' }}>
                            <div>
                                <h1 className="text-center">GSA</h1>
                                <h5>General Sales Agent</h5>
                            </div>
                            <div className="d-flex justify-content-center">
                                <img src={'/images/rusky.png'} width={'100'} className="me-2" />
                                <img src={'/images/logo_pcp.png'} height={'30'} className="mt-4" />
                            </div>
                        </div>
                    </div>
                </div>
