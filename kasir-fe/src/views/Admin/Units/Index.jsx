...
export default function index() {
    ...
    const columns = [
        ...
        {
            name: 'Name',
            selector: (row) => row.unit_name, // Use a selector function
            ...
            cell: (row) => (
                ...
                <div className="btn-group">
                    ...
                    <ul className="dropdown-menu">
                        <li>
                            <Link to={`/admin/units/edit/${row.id}`} className=" dropdown-item">
                                <i className="fa fa-pencil-alt"></i> Edit
                            </Link>
                        </li>
                        {/* <li>
    ...
    const fetchData = async (pageNumber = 1, keywords = '') => {
        ...
        await Api.get(`/admin/units?search=${keywords}&page=${page}`, {
            //header
            headers: {
                //header bearer + token
                            ...
                            <div className="row">
                                <div className="col-md-9 col-12 mb-2">
                                    <div className="input-group">
                                        <TbStatusChange size={25} className="me-2" /> <h5>Units</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="row">
                                    <div className="col-md-8 ">
                                        ...
                                        <div className="container-fluid">
                                            <Link to="/admin/units/create" className="btn btn-md btn-primary border-0 shadow-sm rounded-4 mt-3" type="button">
                                                {' '}
                                                <i className="fa-solid fa-circle-plus"></i> <span className="fw-bold">New units</span>
                                            </Link>
                                        </div>
                                    </div>
                                ...
                                <div className="card-body">
                                    <div className="table-responsive">
                                        <div style={{ borderRadius: '10px', overflow: 'hidden', fontSize: 14 }}>
                                            <MyDataTable url={'/admin/units'} columns={columns} searchData={keywords} />
                                        </div>
                                    </div>
