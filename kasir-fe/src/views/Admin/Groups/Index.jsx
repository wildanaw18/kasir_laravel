...
export default function index() {
            ...
            cell: (row) => (
                ...
                <div className="btn-group">
                    ...
                    <ul className="dropdown-menu">
                        <li>
                            <Link to={`/admin/groups/edit/${row.id}`} className=" dropdown-item">
                                <i className="fa fa-pencil-alt"></i> Edit
                            </Link>
                        </li>
                        {/* <li>
    ...
    const fetchData = async (pageNumber = 1, keywords = '') => {
        ...
        await Api.get(`/admin/group?search=${keywords}&page=${page}`, {
            //header
            headers: {
                //header bearer + token
                            ...
                            <div className="row">
                                <div className="col-md-9 col-12 mb-2">
                                    <div className="input-group">
                                        <TbStatusChange size={25} className="me-2" /> <h5>Groups</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="row">
                                    <div className="col-md-8 ">
                                        ...
                                        <div className="container-fluid">
                                            <Link to="/admin/groups/create" className="btn btn-md btn-primary border-0 shadow-sm rounded-4 mt-3" type="button">
                                                {' '}
                                                <i className="fa-solid fa-circle-plus"></i> <span className="fw-bold">New Groups</span>
                                            </Link>
                                        </div>
                                    </div>
                                ...
                                <div className="card-body">
                                    <div className="table-responsive">
                                        <div style={{ borderRadius: '10px', overflow: 'hidden', fontSize: 14 }}>
                                            <MyDataTable url={'/admin/groups'} columns={columns} searchData={keywords} />
                                        </div>
                                    </div>
