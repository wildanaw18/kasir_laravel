...
export default function index() {
    ...
    const columns = [
        ...
        {
            name: 'Expense Date',
            selector: (row) => row.expense_date, // Use a selector function

            sortField: 'director',
        },
        {
            name: 'Description',
            selector: (row) => row.desc, // Use a selector function

            sortField: 'director',
        },
        {
            name: 'Category',
            selector: (row) => row.category.name, // Use a selector function

            sortField: 'director',
        },
        {
            name: 'Amount',
            selector: (row) => formatPrice(row.amount), // Use a selector function
            ...
            cell: (row) => (
                <div className="btn-group">
                    ...
                    <ul className="dropdown-menu">
                        <li>
                            <Link to={`/admin/expenses/edit/${row.id}`} className=" dropdown-item">
    ...
    const fetchData = async (pageNumber = 1, keywords = '') => {
        ...
        await Api.get(`/admin/expenses?search=${keywords}&page=${page}`, {
            //header
            headers: {
                //header bearer + token
                            ...
                            <div className="row">
                                <div className="col-md-9 col-12 mb-2">
                                    <div className="input-group">
                                        <TbStatusChange size={25} className="me-2" /> <h5>expenses</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="row">
                                    <div className="col-md-8 ">
                                        ...
                                        <div className="container-fluid">
                                            <Link to="/admin/expenses/create" className="btn btn-md btn-primary border-0 shadow-sm rounded-4 mt-3" type="button">
                                                {' '}
                                                <i className="fa-solid fa-circle-plus"></i> <span className="fw-bold">New expenses</span>
                                            </Link>
                                        </div>
                                    </div>
                                ...
                                <div className="card-body">
                                    <div className="table-responsive">
                                        <div style={{ borderRadius: '10px', overflow: 'hidden', fontSize: 14 }}>
                                            <MyDataTable url={'/admin/expenses'} columns={columns} searchData={keywords} />
                                        </div>
                                    </div>
