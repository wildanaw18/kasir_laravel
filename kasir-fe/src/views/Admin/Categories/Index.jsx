...
export default function index() {
    //title page
    document.title = 'categories - KASIR'
    ...
    const columns = [
        ...
        {
            name: 'Group Category',
            selector: (row) => row.group.name, // Use a selector function

            sortField: 'director',
        },
        {
            name: 'Shop Name',
            selector: (row) => row.shop.shop_name, // Use a selector function
            ...
            cell: (row) => (
                <div className="btn-group">
                    ...
                    <ul className="dropdown-menu">
                        <li>
                            <Link to={`/admin/categories/edit/${row.id}`} className=" dropdown-item">
    ...
    const fetchData = async (pageNumber = 1, keywords = '') => {
        ...
        await Api.get(`/admin/categories?search=${keywords}&page=${page}`, {
            //header
            headers: {
                //header bearer + token
                            ...
                            <div className="row">
                                <div className="col-md-9 col-12 mb-2">
                                    <div className="input-group">
                                        <TbStatusChange size={25} className="me-2" /> <h5>categories</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="row">
                                    <div className="col-md-8 ">
                                        ...
                                        <div className="container-fluid">
                                            <Link to="/admin/categories/create" className="btn btn-md btn-primary border-0 shadow-sm rounded-4 mt-3" type="button">
                                                {' '}
                                                <i className="fa-solid fa-circle-plus"></i> <span className="fw-bold">New categories</span>
                                            </Link>
                                        </div>
                                    </div>
                                ...
                                <div className="card-body">
                                    <div className="table-responsive">
                                        <div style={{ borderRadius: '10px', overflow: 'hidden', fontSize: 14 }}>
                                            <MyDataTable url={'/admin/categories'} columns={columns} searchData={keywords} />
                                        </div>
                                    </div>
