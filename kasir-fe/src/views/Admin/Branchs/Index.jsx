...
export default function index() {
    ...
    const columns = [
        ...
        {
            name: 'Branch Name',
            selector: (row) => row.branch_name, // Use a selector function

            sortField: 'director',
        },
        {
            name: 'Branch Code',
            selector: (row) => row.branch_code, // Use a selector function
            ...
            cell: (row) => (
                <div className="btn-group">
                    ...
                    <ul className="dropdown-menu">
                        <li>
                            <Link to={`/admin/branchs/edit/${row.id}`} className=" dropdown-item">
    ...
    const fetchData = async (pageNumber = 1, keywords = '') => {
        ...
        await Api.get(`/admin/branchs?search=${keywords}&page=${page}`, {
            //header
            headers: {
                //header bearer + token
            ...
            setBranchs(response.data.data.data)
                            ...
                            <div className="row">
                                <div className="col-md-9 col-12 mb-2">
                                    <div className="input-group">
                                        <TbStatusChange size={25} className="me-2" /> <h5>Branchs</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="row">
                                    <div className="col-md-8 ">
                                        ...
                                        <div className="container-fluid">
                                            <Link to="/admin/branchs/create" className="btn btn-md btn-primary border-0 shadow-sm rounded-4 mt-3" type="button">
                                                {' '}
                                                <i className="fa-solid fa-circle-plus"></i> <span className="fw-bold">New branchs</span>
                                            </Link>
                                        </div>
                                    </div>
                                ...
                                <div className="card-body">
                                    <div className="table-responsive">
                                        <div style={{ borderRadius: '10px', overflow: 'hidden', fontSize: 14 }}>
                                            <MyDataTable url={'/admin/branchs'} columns={columns} searchData={keywords} />
                                        </div>
                                    </div>
