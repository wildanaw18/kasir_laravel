            ...
            <main>
                <form onSubmit={storeGood}>
                    <div className="container-fluid mt-4">
                        <Link to="/admin/suppliers" className="btn btn-orange rounded-4 text-white ">
                            Kembali
                        </Link>
                        <div className="card mt-3 shadow rounded">
                            <div className="card-header">
                                {' '}
                                <h4 style={{ fontWeight: 'bold' }}>suppliers</h4>
                            </div>
                                ...
                                <div className="container-fluid">
                                    <div className="row mb-2">
                                        <div className="col-md-12">
                                            ...
                                            <input type="text" className="form-control" placeholder="Supplier Name" value={supplier_name} onChange={(e) => setSupplierName(e.target.value)} />
